...
"settings":
{
	...
	"email_settings" : 
	{
		...
		"notification_message" : 
		{
			...
			"custom" : 
			{
				...
				"is_present" : true,
				"key" : "custom-code",
				"subject" : "Alguem contactou pelo website www.hozenconsulting.com"
			},
			"from" : "info@hozenconsulting.com",
			"is_present" : true,
			"replyto" : "",
			"to" : "info@hozenconsulting.com"
		}
	},
	"general_settings" : 
	{
	...
	"redirect_settings" : 
	{
		...
		"gotopage" : "",
		"inline" : "<center>\n<style type=\"text/css\">\n#docContainer table {margin-top: 30px; margin-bottom: 30px; width:80% !important;}\n#docContainer td {font-size: 12px !important; line-height: 30px;color: #ffffff !important; margin: 0px;border-bottom: 1px solid #ffffff;}\n#docContainer td:first-child {font-size: 13px !important; font-weight:bold; color: #ffffff !important; vertical-align:text-top; min-width:50%; padding-right:5px;}\n</style>\n[_form_results_]\n<h2>Thank you!</h2><br/>\n<p>Your form was successfully submitted. We received the information shown above.</p>\n</center>",
		"type" : "inline"
	},
	"uid" : "336d4ed2c58b6ecb6331dc2e7073f59e",
	"validation_report" : "in_line"
},
"rules":{"nome":{"label":"Nome","fieldtype":"text"},"email":{"email":true,"label":"Email","fieldtype":"email","required":true},"phone":{"phone":"international","label":"Celular","fieldtype":"tel","required":true},"text15":{"label":"Empresa","fieldtype":"text"},"comments":{"label":"Coment&aacute;rio","fieldtype":"textarea","maxlength":"10000"}},
"payment_rules":{},
"conditional_rules":{},
